	...
	<AlertDialog.Content>
		<AlertDialog.Header>
			<div class="flex items-center gap-3">
				...
				<div>
					<AlertDialog.Title>Konfirmasi Pengiriman GRN Re-Conditioned Stock</AlertDialog.Title>
					<AlertDialog.Description>
						Apakah Anda yakin ingin mengirim penerimaan barang re-conditioned stock ini untuk
						persetujuan?
					</AlertDialog.Description>
				</div>
			</div>
		...
		<p class="text-sm text-muted-foreground">
			Setelah dikirim, GRN akan diajukan ke Askep/Tekniker 1 untuk persetujuan dan tidak dapat
			dibatalkan. Pastikan semua informasi sudah benar.
		</p>
