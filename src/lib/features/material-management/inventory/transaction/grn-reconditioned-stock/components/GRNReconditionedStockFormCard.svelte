<script lang="ts">
	...
	// Auto-fill defaults — Store is always "GUDANG"
	$effect(() => {
		if (!formData.date) {
...
<Card>
	<CardHeader>
		<CardTitle class="text-lg">Detail Penerimaan Barang Re-Conditioned Stock</CardTitle>
	</CardHeader>
	<CardContent class="space-y-4">
		<div class="grid gap-4 md:grid-cols-2">
			...
			<div class="space-y-2">
				<Label>Gudang</Label>
				<Input value="GUDANG" readonly class="cursor-not-allowed bg-muted" />
			</div>
