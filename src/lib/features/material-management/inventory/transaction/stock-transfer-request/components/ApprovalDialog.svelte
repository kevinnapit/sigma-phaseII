<script lang="ts">
	...
	const title = $derived(isApprove ? 'Setujui Permintaan' : 'Tolak Permintaan');
	const description = $derived(
		isApprove
			? 'Apakah Anda yakin ingin menyetujui permintaan transfer stok ini?'
			: 'Apakah Anda yakin ingin menolak permintaan transfer stok ini?'
	);
