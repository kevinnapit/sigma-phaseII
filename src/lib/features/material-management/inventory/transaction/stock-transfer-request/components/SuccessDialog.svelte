...
<Dialog.Root bind:open>
	<Dialog.Content class="sm:max-w-md">
		<div class="text-center py-6">
			...
			<!-- Title -->
			<h2 class="text-2xl font-semibold mb-3">Permintaan Transfer Stok Berhasil Dibuat</h2>
			
			<!-- Description -->
			<p class="text-sm text-muted-foreground mb-6">
				Permintaan transfer stok Anda telah berhasil dibuat dengan nomor:
			</p>
			...
			<div class="rounded-lg border bg-muted/30 p-4 mb-6">
				<div class="flex items-center justify-between mb-4">
					<div class="flex items-center gap-3">
						...
						<div class="text-left">
							<p class="text-xs text-muted-foreground">Nomor Transfer</p>
							<p class="font-semibold text-base">{requestNumber}</p>
						</div>
					</div>
				...
				<div class="flex gap-2">
					...
					<Button size="sm" class="flex-1 bg-green-700 hover:bg-green-800" onclick={handleSubmitAnother}>
