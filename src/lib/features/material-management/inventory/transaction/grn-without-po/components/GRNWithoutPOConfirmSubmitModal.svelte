	...
	<AlertDialog.Content>
		<AlertDialog.Header>
			<div class="flex items-center gap-3">
				...
				<div>
					<AlertDialog.Title>Konfirmasi Pengiriman GRN Tanpa PO</AlertDialog.Title>
					<AlertDialog.Description>
						Apakah Anda yakin ingin mengirim penerimaan barang tanpa PO ini untuk persetujuan?
					</AlertDialog.Description>
				</div>
			</div>
		</AlertDialog.Header>
